<template>
    <div class="card">
        ...
        <p class="bg-primary border-round p-3">This page covers the Vite version, for Nuxt 3 visit the <a
                ...
                class="font-bold bg-primary hover:underline">sakai-nuxt</a> repository instead.</p>
        ...
        <p>Next step is running the application using the serve script and navigate to <i>http://localhost:5174/</i> to
        ...
        <p>In case you&apos;d like to customize the main layout variables, open <b>_variables.scss</b> file under
            src/layout folder. Saving the changes will be reflected instantly at your browser.</p>
